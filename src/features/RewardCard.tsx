...
export default function RewardCard({ title, description, cost, type, isComingSoon, userBalance }: RewardCardProps) {
  ...
  return (
    <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm flex flex-col items-center text-center h-full hover:shadow-md transition-shadow">
