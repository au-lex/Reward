...
// Features
import StreakCard from '../../features/StreakCard';
      ...
      <section className="font-sans max-w-7xl mx-auto">
        ...
        {activeTab === 'earn' ? (
          <div className="space-y-8 animate-in slide-in-from-left-4 duration-300">
            ...
            {/* Top Section: Journey Grid */}
            <div>
              <div className="flex items-center gap-2 mb-6 border-l-4 border-purple-600 pl-3">
                <h2 className="text-lg font-bold text-gray-900">Your Rewards Journey</h2>
              </div>
